...
BESORAH_BOOKS = [
    ...
    ("shamoth",        "SHAMOTH",          "Exodus",         "Torah",  102, 40),
    ("wayyiqra",       "WAYYIQRA",         "Leviticus",      "Torah",  150, 27),
    ("bamidbar",       "BAMIḎBAR",         "Numbers",        "Torah",  185, 36),
    ("dabarim",        "DAḆARIM",          "Deuteronomy",    "Torah",  235, 34),
    # Nebi'im
    ("yahusha",        "YAHUSHA",          "Joshua",         "Nabi'im", 277, 24),
    ("shophetim",      "SHOPHETIM",        "Judges",         "Nabi'im", 306, 21),
    ("1shamual",       "1 SHAMU'AL",       "1 Samuel",       "Nabi'im", 335, 31),
    ("2shamual",       "2 SHAMU'AL",       "2 Samuel",       "Nabi'im", 372, 24),
    ("1malakim",       "1 MALAḴIM",        "1 Kings",        "Nabi'im", 404, 22),
    ("2malakim",       "2 MALAḴIM",        "2 Kings",        "Nabi'im", 441, 25),
    ("yashayahu",      "YASHAYAHU",        "Isaiah",         "Nabi'im", 476, 66),
    ("yirmayahu",      "YIRMAYAHU",        "Jeremiah",       "Nabi'im", 531, 52),
    ("yahazqal",       "YAHAZQ'AL",        "Ezekiel",        "Nabi'im", 595, 48),
    ("danial",         "DANI'AL",          "Daniel",         "Nabi'im", 652, 12),
    ("hoshea",         "HOSHĔA",           "Hosea",          "Nabi'im", 670, 14),
    ("yoal",           "YO'AL",            "Joel",           "Nabi'im", 678, 3),
    ("amos",           "AMOS",             "Amos",           "Nabi'im", 682, 9),
    ("obadyahu",        "OḆADYAHU",          "Obadiah",        "Nabi'im", 689, 1),
    ("yonah",          "YONAH",            "Jonah",          "Nabi'im", 690, 4),
    ("mikah",          "MIḴAH",            "Micah",          "Nabi'im", 693, 7),
    ("nahum",          "NAḤUM",            "Nahum",          "Nabi'im", 698, 3),
    ("habaqquq",       "ḤAḆAQQUQ",         "Habakkuk",       "Nabi'im", 700, 3),
    ("tsephanyahu",     "TSEPHANYAHU",       "Zephaniah",      "Nabi'im", 703, 3),
    ("haggai",         "ḤAGGAI",           "Haggai",         "Nabi'im", 706, 2),
    ("zakaryahu",       "ZAḴARYAHU",         "Zechariah",      "Nabi'im", 708, 14),
    ("malaki",         "MAL'AḴI",          "Malachi",        "Nabi'im", 718, 4),
    # Kethubim
...
def build_apocrypha():
    ...
    APOC_BOOKS = [
        ...
        ("epistle-jeremiah","IGGERETH YIRMAYAHU","Letter of Jeremiah",    205, 1),
